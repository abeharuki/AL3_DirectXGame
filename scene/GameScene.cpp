...
// 正射影行列
Matrix4x4 GameScene::MakeOrthographicMatrix(
...
// 回転X
Matrix4x4 GameScene::MakeRotateXMatrix(float theta = 0) {
...
// Y
Matrix4x4 GameScene::MakeRotateYMatrix(float theta = 0) {
	Matrix4x4 MakeRotateMatrix;
...
// Z
Matrix4x4 GameScene::MakeRotateZMatrix(float theta = 0) {
	Matrix4x4 MakeRotateMatrix;
	MakeRotateMatrix.m[0][0] = std::cos(theta);
...
// アフィン変換
Matrix4x4 GameScene::MakeAffineMatrix(
